...
(0,_inertiajs_inertia_vue3_src__WEBPACK_IMPORTED_MODULE_1__.createInertiaApp)({
  ...
  //Hubicación de los componenetes
  setup: function setup(_ref) {
    ...
    }) //createApp típico de vue
    .mixin({
      methods: {
        route: window.route
      }
    }) //método route de ziggu
...
var map = {
	...
	"./ppal": [
		"./resources/js/Pages/ppal.vue",
		"resources_js_Pages_ppal_vue"
	],
	"./ppal.vue": [
		"./resources/js/Pages/ppal.vue",
		"resources_js_Pages_ppal_vue"
...
/******/ 			if ({"resources_js_Pages_AboutComponent_vue":1,"resources_js_Pages_ej1_vue":1,"resources_js_Pages_ppal_vue":1}[chunkId]) return "js/" + chunkId + ".js";
